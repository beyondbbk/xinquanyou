...
//开始上传
{
    ...
    function SumbitInfo() {
        ...
        var timeId = setInterval(function() {
            ...
            if (imgCompressDoneNum==choosedPicBlobs.length) {
                ...
                window.location.href = "/tjqxj/home/success?headTitle=上传成功&desc=信息已保存于服务端，即时生效。";
            } 
        }, 500);
    }
    ...
    function PostImgInfo(blob,fileNum) {
        var url = "/tjqxj/home/saveproduct"; //接收上传文件的后台地址
        var form = new FormData(); // FormData 对象
        form.append("file", blob, chooseProduct + "-" + choosedPicNames[fileNum]); //文件对象
