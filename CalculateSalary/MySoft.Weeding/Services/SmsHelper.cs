...
namespace MySoft.Weeding.Services
{
    public static class SmsHelper
    {
        ...
        const String accessKeyId = "LTAIelSYZD0UCniv";
        const String accessKeySecret = "mbTENWFDnNVipKMLhYgG0A5pWtWJJg";
        ...
        private static SendBatchSmsResponse SendBatchSms()
        {
            IClientProfile profile = DefaultProfile.GetProfile("cn-hangzhou", accessKeyId, accessKeySecret);
            DefaultProfile.AddEndpoint("cn-hangzhou", "cn-hangzhou", product, domain);
        ...
        public static bool SendSms(string phoneNo,string name)
        {
            SendSmsResponse reponse = SendSingleSms(phoneNo,name);
            LogHelper.Info("短信发送Code："+reponse.Code +" 描述："+ reponse.Message);
