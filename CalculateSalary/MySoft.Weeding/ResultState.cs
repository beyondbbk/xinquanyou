namespace MySoft.Weeding
{
    public enum ResultState
    {
        ...
        /// 操作过于频繁
        /// </summary>
        GlobalQueryFrequentError = -1001017,
        #endregion
        ...
        #region 找零认证   [1X19XXX]  前缀GetChange

        /// <summary>
        /// 找零状态失败(已找零/找零失败)
        /// </summary>
        GetChangeStateError = -1119001,

        /// <summary>
        /// 车牌不符
        /// </summary>
        GetChangeCarNoError = -1119002,
        #endregion


        #region 电子发票   [1X20XXX]  前缀ElecReceipt

        /// <summary>
        /// 订单重复开发票
        /// </summary>
        ElecReceiptRepeat = -1120001,

        /// <summary>
        /// 找不到订单记录
        /// </summary>
        ElecReceiptNotFound = -1120002,

        /// <summary>
        /// 订单跨停车场
        /// </summary>
        ElecReceiptSpanPark = -1120003,

        /// <summary>
        /// 订单不是有效停车付费订单
        /// </summary>
        ElecReceiptNotValid = -1120004,

        /// <summary>
        /// 流水号无效
        /// </summary>
        ElecReceiptWrongNo = -1120005,

        /// <summary>
        /// 公司信息太短，无法匹配，2个及以上才能进行匹配
        /// </summary>
        ElecReceiptTooShort = -1120005,

        /// <summary>
        /// 购买方信息错误
        /// </summary>
        ElecReceiptErrorPurchaserInfo = -1120006,
        #endregion
